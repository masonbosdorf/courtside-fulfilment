...
async function main() {
  ...
  // NO customer names/addresses here: the seed is served from a PUBLIC repo. Pick slips get
  // their PII from pick-fetch.js, encrypted.
  ...
  const DETAIL_SEL = 'totalPriceSet{shopMoney{amount}} shippingLine{title}';
